...
<section class="overview">
    <div class="container">
        <h1 class="h1">Vehicle Overview</h1>
        ...
        <table class="technical__table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="technical__value">
                        {{ $report->guarantee_check ? 'Until ' .$report->guarantee_month . ' / ' .$report->guarantee_year : 'No' }}
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div class="container flex">
        <div class="recommendation-left left">
            ...
            <div class="recommendation__text">
                ...
                @if($report->equipmentStatus  == 'Remarks')
                    <p>
                        {{ $report->functions_check ? 'There are issues with the following options:' : ''}} <br>
        ...
        <div class="recommendation__cost right">
            <img src="{{ url('/assets/money.png') }}" alt="cost">
...
<header class="header ">
    <div class="container header__container">
        ...
        <div class="header__qr-text">
            Scan the QR-code to see our contacts
        </div>
    </div>
...
<section class="components">
    <div class="container">
        <div class="h1">Registration data</div>
        <table>
            <tr>
                ...
                @if ( $report->photo_tech_info)
                    <td class="components__item item">
                        <div class="item__image">
                            <img class="item__image" src="{{ $report->photo_tech_info }}" alt="Vehicle Information">
                        </div>
...
<section class="components brakes">
    ...
    <header class="header ">
        <div class="container header__container">
            ...
            <div class="header__qr-text">
                Scan the QR code to view our contacts
            </div>
        </div>
    </header>
    <br><br>
