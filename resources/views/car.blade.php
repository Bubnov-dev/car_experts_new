...
<section class="technical">
    <div class="container">
        ...
        <div class="technical__item">
            ...
            <div class="technical__value">
                {{ $report->guarantee_check ? 'До ' . ($report->guarantee_mileage ? $report->guarantee_mileage . ' / ' : '') . ($report->gu                .guarantee_month ? $report->guarantee_month . ' / ' : ' ')  .$report->guarantee_year : 'Нет' }}
            </div>
        </div>
