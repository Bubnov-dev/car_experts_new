...
{{--                                <div class="values__part">{{ $translate[$measurement->part] }}</div>--}}
{{--                                <div class="values__bar">--}}
{{--                                    <div class="bar__fill" style="width: {{ $measurement->value }}%"></div>--}}
{{--                                </div>--}}
{{--                                <div class="values__value">{{ $measurement->value }} мкм</div>--}}
{{--                            </div>--}}
{{--                        @endforeach--}}
                    </div>
                </div>
